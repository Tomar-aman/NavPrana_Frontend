...
const Page = ({ initialFaqs = [] }) => {
  ...
  useEffect(() => {
    // Server already provided FAQ data for first paint + SEO/AEO crawlers.
    // Only fetch client-side if the server fetch didn't return anything.
