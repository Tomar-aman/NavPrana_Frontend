          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-primary-border rounded-lg focus:ring-2 focus:ring-primary"
              />
            </div>
            {errors.email && (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2 border border-primary-border rounded-lg focus:ring-2 focus:ring-primary"
              />
              <button
                type="button"
